...
//This method uses the toString method defined on each individual block.
    ...
    public String createXML() {
        String xml = "<BlockList>\n";

        for (Block b : Chain) {

            xml += "<Block>";
            xml += "\n";
            xml += "\t" + "<index>" + b.getIndex() + "</index>";
            xml += "\n";
            xml += "\t" + "<timeStamp>" + b.getTimestamp() + "</timeStamp>";
            xml += "\n";
            xml += "\t" + "<data>" + b.getData() + "</data>";
            xml += "\n";
            xml += "\t" + "<prevHash>" + b.getPreviousHash() + "</prevHash>";
            xml += "\n";
            xml += "\t" + "<difficulty>" + b.getDifficulty() + "</difficulty>";
            xml += "\n";
            xml += "</Block>";
            xml += "\n";
        }
       
        xml += "\t" + "<chainHash>" +chainHash + "</chainHash>";
        xml += "\n";
